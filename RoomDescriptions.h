...
string creatureDesc(int cid, vector<Creature> creatureDirectory, Player &hero, int ch=-1)
{
    ...
    {
        return "The man raises his hammer and approaches you. 'Some curses aren't meant to be broken, fool... Those who hunger for power are all the same. Wretched, evil worms who are doomed to ruin the lives of others. This tower is all that keeps the power-hungry at bay, attracting them like moths to a flame, promising glory, riches, power beyond their wildest fantasy... as one of them, you should know all too well. Are these truly the ones you hope to save by defeating me? Then so be it. I will not let the world suffer for the sake of your glory.' The man raises his hammer toward the sky at the tower's apex, ready for battle.";
    }
    else if(cid==57)
    {
